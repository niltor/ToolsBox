...
namespace Test
{
    ...
    class ApiModel
    {
        ...
        /// <returns></returns>
        public String GetItemsContent(List<Operation> items, string folder = null)
        {
            var content = "";
        ...
        /// <param name="items"></param>
        /// <returns></returns>
        public string ToMarkdown(List<Operation> items)
        {
            // 获取接口内容
        ...
        public string GetParams(List<Parameter> @params)
        {
            if (@params == null)
                return "";
            var result = "#### 请求body参数 \r\n|键|值|类型|说明|\r\n|-|-|-|-|\r\n";
    ...
    public class ApiItem
    {
        ...
        public List<Parameter> ResponseFileds { get; set; }
